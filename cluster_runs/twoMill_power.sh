...
run_name="twoMill_power"       # Name of the series (of runs), identifying the results folder
...
hyperparams=" 	--learning_rate (float) : 5e-3, 5e-4  \
		--stopping_patience (int): 30   \
		--blocks (int): 2,4  		 \
		--features (int): 128,32,4  	 \
		--dropout (float): 0,0.1,0.2 	 \
		--data_features (int): 128,32,4 \
		--power_features (int): 128,32,4 \
"	



start_grid_test_at_count=31
