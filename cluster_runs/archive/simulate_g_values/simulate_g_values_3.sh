...
max_memory_config=10
max_time_config=00-00:05:00
partition_config=normal
qos_config="devel"


run_name="simulate_g_values" # Name of the series (of runs), identifying the results folder
...
nbins="              100      " # Bins: Number of bins in spectrum
nbins_etrue="        300      " # Bins: Number of bins in spectrum
...
param2="  [0.4:0.4]   |    10    |    0    |    0    |    g        | e-11GeV^{-1}" # coupling constant g in 10^(-11) /GeV
...
n_jobs_sim=1				# Number of jobs to share simulation over
max_memory_sim=5			# Total memory per job, in GB, must be integer
max_time_sim=00-00:02:00		# Max walltime per job ("dd-hh:mm:ss")   
