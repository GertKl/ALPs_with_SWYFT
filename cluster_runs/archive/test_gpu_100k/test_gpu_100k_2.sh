...
run_name="test_gpu_100k" 		# Name of the series (of runs), identifying the results folder
...
param1="  [0.1:0.9]         |    10    |    0    |    0    |    m        |     nev     " # mass m in neV
...
max_time_sim=00-04:00:00		# Max walltime per job ("dd-hh:mm:ss")   
...
train_batch_size_1d=1000		# Batch size during training (for 1D and 2D posteriors) 
max_epochs=5
