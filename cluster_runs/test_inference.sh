...
run_name="test_inference_2"      # Name of the series (of runs), identifying the results folder
...
param6="  [1.79:3.79]       |    10    |  2.75    |    1    | Ecut        |             " # Cut-off energy Ecut, in GeV 
...
0 | -9 | 1.5 | 800 | 25.0 | 39.0 | 4.05 | 500.0 | 80.0 | 280.0 | 1.2 | 0.58 | 0.5 | 0.18 | 9.0 | 2.8  ,\
0 | -9 | 2.5 | 800 | 25.0 | 39.0 | 4.05 | 500.0 | 80.0 | 280.0 | 1.2 | 0.58 | 0.5 | 0.18 | 9.0 | 2.8  \
"
...
use_old_sims=0 #$FOML3/cluster_runs/analysis_results/test_inference_2/archive/trial__3/store/store # $FOML3/cluster_runs/storee/storicist
save_old_sims=0
simulate=1
...
n_jobs_sim=8192				# Number of jobs to share simulation over
max_memory_sim=40			# Total memory per job, in GB, must be integer
max_time_sim=03-00:00:00		# Max walltime per job ("dd-hh:mm:ss")   
