...
if __name__ == "__main__":
    ...
    print("Parsing arguments-string to set_parameters.py... ", end="")
    ...
    print("Converting arguments-string to variables... ", end="")
    config_dict = {}
    ...
    file_control = open(results_dir + "/check_variables.txt", "w")
    for key in config_dict.keys():    
        file_control.write(str(key) +" : " + str(config_dict[key])+"\n")
    file_control.close()
    print("Printed configuration variables to control_variables.txt")
    
    with open(results_dir+'/config_variables.pickle','wb') as file:
        pickle.dump(config_dict, file)
    print("Saved all configuration variables to config_variables.pickle")
    print()
