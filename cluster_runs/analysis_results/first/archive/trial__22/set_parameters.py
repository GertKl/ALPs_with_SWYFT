...
if __name__ == "__main__":
    ...
    for item in config_list:
        ...
        if len(config_argument_name_and_value)>1:
            ...
            config_dict[config_argument_name_and_value[0]] = config_dict_item[0] if is_item_1d else config_dict_item
            ...
            if len(config_argument_name_and_value)==3:
                ...
                config_dict[config_argument_name_and_value[0]] = np.array(config_dict[config_argument_name_and_value[0]]).astype(config_argument_name_and_value[2])
                
                if is_item_1d==0 or is_row_1d==0:
                    
                    config_dict[config_argument_name_and_value[0]] = list(config_dict[config_argument_name_and_value[0]])
                    
                else:
                    
                    config_dict[config_argument_name_and_value[0]] = getattr(__builtins__, config_argument_name_and_value[2])(config_dict[config_argument_name_and_value[0]])
    ...
    # Formatting POI indices 
    
    config_dict['POI_indices'] = [ globals()['int'](x) for x in config_dict['POI_indices'] ]
    
    
    print(config_dict['POI_indices'])
    print()    
