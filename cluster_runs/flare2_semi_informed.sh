...
run_name="flare2_semi_informed"       # Name of the series (of runs), identifying the results folder. If
...
param1=" [-2 , 4]      |  1.2   | -6     | 1 | U               |    m        |     nev      " # mass m in neV
param2=" [-2 , 1]      |  1     | -5     | 1 | U               |    g        | e-11GeV^{-1} " # coupling constant g in 10^(-11) /GeV
